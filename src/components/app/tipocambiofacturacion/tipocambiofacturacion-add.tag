...
<tipocambiofacturacion-add>
	<page id="tipocambiofacturacion-add" title="Agregar TipoCambioFacturacions">
		<formbox title="Datos del TipoCambioFacturacion" icon="fa fa-check-circle-o" action="create" return="tipoCambioFacturacion-admin">
			<div class="row">
				<div class="col-md-4">
