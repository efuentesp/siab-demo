...
<tipocambiofacturacion-delete>
	<page id="tipocambiofacturacion-delete" title="Eliminar TipoCambioFacturacions">
		<formbox title="Datos del TipoCambioFacturacion" icon="fa fa-check-circle-o" action="delete" return="tipoCambioFacturacion-admin">
			<div class="row">
				<div class="col-md-4">
