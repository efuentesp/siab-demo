...
<entidadinegi-add>
	<page id="entidadinegi-add" title="Agregar EntidadInegis">
		<formbox title="Datos del EntidadInegi" icon="fa fa-check-circle-o" action="create" return="entidadInegi-admin">
			<div class="row">
				<div class="col-md-4">
