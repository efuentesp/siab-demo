...
<tipocambio_facturacion-add>
	<page id="tipocambio_facturacion-add" title="Agregar TipoCambio_Facturacions">
		<formbox title="Datos del TipoCambio_Facturacion" icon="fa fa-check-circle-o" action="create" return="tipoCambio_Facturacion-admin">
			<div class="row">
				<div class="col-md-4">
