...
<error_pagoe-add>
	<page id="error_pagoe-add" title="Agregar Error_PagoEs">
		<formbox title="Datos del Error_PagoE" icon="fa fa-check-circle-o" action="create" return="error_PagoE-admin">
			<div class="row">
				<div class="col-md-4">
