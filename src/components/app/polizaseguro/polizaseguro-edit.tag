...
<polizaseguro-edit>
	<page id="polizaseguro-edit" title="Editar PolizaSeguros">
		<formbox title="Datos del PolizaSeguro" icon="fa fa-check-circle-o" action="update" return="polizaSeguro-admin">
			<div class="row">
				<div class="col-md-4">	
