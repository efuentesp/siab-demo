...
<tipoerror_cc_saaim3-add>
	<page id="tipoerror_cc_saaim3-add" title="Agregar TipoError_CC_SAAIM3s">
		<formbox title="Datos del TipoError_CC_SAAIM3" icon="fa fa-check-circle-o" action="create" return="tipoError_CC_SAAIM3-admin">
			<div class="row">
				<div class="col-md-4">	
