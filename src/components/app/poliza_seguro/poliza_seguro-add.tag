...
<poliza_seguro-add>
	<page id="poliza_seguro-add" title="Agregar Poliza_Seguros">
		<formbox title="Datos del Poliza_Seguro" icon="fa fa-check-circle-o" action="create" return="poliza_Seguro-admin">
			<div class="row">
				<div class="col-md-4">	
