...
<tiporeg_solcc-add>
	<page id="tiporeg_solcc-add" title="Agregar TipoReg_SolCCs">
		<formbox title="Datos del TipoReg_SolCC" icon="fa fa-check-circle-o" action="create" return="tipoReg_SolCC-admin">
			<div class="row">
				<div class="col-md-4">
