...
<acting_catalogo-edit>
	<page id="acting_catalogo-edit" title="Editar Acting_Catalogos">
		<formbox title="Datos del Acting_Catalogo" icon="fa fa-check-circle-o" action="update" return="acting_Catalogo-admin">
			<div class="row">
				<div class="col-md-4">
