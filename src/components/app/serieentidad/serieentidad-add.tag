...
<serieentidad-add>
	<page id="serieentidad-add" title="Agregar SerieEntidads">
		<formbox title="Datos del SerieEntidad" icon="fa fa-check-circle-o" action="create" return="serieEntidad-admin">
			<div class="row">
