...
<serieentidad-delete>
	<page id="serieentidad-delete" title="Eliminar SerieEntidads">
		<formbox title="Datos del SerieEntidad" icon="fa fa-check-circle-o" action="delete" return="serieEntidad-admin">
			<div class="row">
