...
<entidadfederativa-add>
	<page id="entidadfederativa-add" title="Agregar EntidadFederativas">
		<formbox title="Datos del EntidadFederativa" icon="fa fa-check-circle-o" action="create" return="entidadFederativa-admin">
			<div class="row">
				<div class="col-md-4">
