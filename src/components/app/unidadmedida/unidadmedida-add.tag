...
<unidadmedida-add>
	<page id="unidadmedida-add" title="Agregar UnidadMedidas">
		<formbox title="Datos del UnidadMedida" icon="fa fa-check-circle-o" action="create" return="unidadMedida-admin">
			<div class="row">
				<div class="col-md-4">
