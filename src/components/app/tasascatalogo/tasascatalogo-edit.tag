...
<tasascatalogo-edit>
	<page id="tasascatalogo-edit" title="Editar TasasCatalogos">
		<formbox title="Datos del TasasCatalogo" icon="fa fa-check-circle-o" action="update" return="tasasCatalogo-admin">
			<div class="row">
				<div class="col-md-4">
