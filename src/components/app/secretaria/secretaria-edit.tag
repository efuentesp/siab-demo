...
<secretaria-edit>
	<page id="secretaria-edit" title="Editar Secretarias">
		<formbox title="Datos del Secretaria" icon="fa fa-check-circle-o" action="update" return="secretaria-admin">
			<div class="row">
				<div class="col-md-4">
			...
			<p hidden>2</p>
				...
				<inputbox id="SecretariaAbrev" type="text" label="Abreviación" value="" placeholder="Abreviación de la Secretaría" required=true disabled=false />
				</div>
			</div>
