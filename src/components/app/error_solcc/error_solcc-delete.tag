...
<error_solcc-delete>
	<page id="error_solcc-delete" title="Eliminar Error_SolCCs">
		<formbox title="Datos del Error_SolCC" icon="fa fa-check-circle-o" action="delete" return="error_SolCC-admin">
			<div class="row">
			...
			<p hidden>1</p>
				<div class="col-md-4">
				<inputbox id="ErrorSolCCCampo" type="number" pattern="[0-9]" onkeypress="return event.charCode >= 48 && event.charCode <= 57" label="Campo" value="" placeholder="Campo" required=true disabled=true minsize=3 maxsize=100 />
				</div>
			
			<p hidden>2</p>
				<div class="col-md-4">
				<inputbox id="ErrorSOLCCConsecutivo" type="number" pattern="[0-9]" onkeypress="return event.charCode >= 48 && event.charCode <= 57" label="Consecutivo" value="" placeholder="Consecutivo" required=true disabled=true minsize=3 maxsize=100 />
				</div>
			</div>
			...
			<p hidden>4</p>
				...
				<inputbox id="ErrorSolCCDes" type="textarea" label="Descripción" value="" placeholder="Descripción" required=true disabled=true />
				</div>
