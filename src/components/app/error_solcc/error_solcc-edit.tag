...
<error_solcc-edit>
	<page id="error_solcc-edit" title="Editar Error_SolCCs">
		<formbox title="Datos del Error_SolCC" icon="fa fa-check-circle-o" action="update" return="error_SolCC-admin">
			<div class="row">
