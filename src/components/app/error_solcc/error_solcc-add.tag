...
<error_solcc-add>
	<page id="error_solcc-add" title="Agregar Error_SolCCs">
		<formbox title="Datos del Error_SolCC" icon="fa fa-check-circle-o" action="create" return="error_SolCC-admin">
			<div class="row">
