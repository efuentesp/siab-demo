...
<regulacion-edit>
	<page id="regulacion-edit" title="Editar Regulacions">
		<formbox title="Datos del Regulacion" icon="fa fa-check-circle-o" action="update" return="regulacion-admin">
			<div class="row">
				<div class="col-md-4">	
			...
			<p hidden>1</p>
				...
				<inputbox id="RegulaAbrev" type="text" label="Abreviación Regulación" value="" placeholder="Abreviación" required=true disabled=false />
				</div>
			...
			<p hidden>4</p>
				<div class="col-md-4">
				<date-picker id="RegulaFechaIni" type= "date" label="Fecha Inicial" placeholder="Fecha Inicial" required=true disabled=false />
				</div>
			
			<p hidden>5</p>
				<div class="col-md-4">
				<date-picker id="RegulaFechaFin" type= "date" label="Fecha Final" placeholder="Fecha Final" required=true disabled=false />
				</div>
			</div>
