...
<catalogoeventosac-edit>
	<page id="catalogoeventosac-edit" title="Editar CatalogoEventoSACs">
		<formbox title="Datos del CatalogoEventoSAC" icon="fa fa-check-circle-o" action="update" return="catalogoEventoSAC-admin">
			<div class="row">
				<div class="col-md-4">
