...
<catalogotenedorescertificado-delete>
	<page id="catalogotenedorescertificado-delete" title="Eliminar CatalogoTenedoresCertificados">
		<formbox title="Datos del CatalogoTenedoresCertificado" icon="fa fa-check-circle-o" action="delete" return="catalogoTenedoresCertificado-admin">
			<div class="row">
