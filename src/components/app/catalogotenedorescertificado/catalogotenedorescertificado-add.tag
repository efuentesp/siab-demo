...
<catalogotenedorescertificado-add>
	<page id="catalogotenedorescertificado-add" title="Agregar CatalogoTenedoresCertificados">
		<formbox title="Datos del CatalogoTenedoresCertificado" icon="fa fa-check-circle-o" action="create" return="catalogoTenedoresCertificado-admin">
			<div class="row">
