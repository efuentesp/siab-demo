...
<identificador-add>
	<page id="identificador-add" title="Agregar Identificadors">
		<formbox title="Datos del Identificador" icon="fa fa-check-circle-o" action="create" return="identificador-admin">
			<div class="row">
