...
<tipocambio_certificacion-edit>
	<page id="tipocambio_certificacion-edit" title="Editar TipoCambio_Certificacions">
		<formbox title="Datos del TipoCambio_Certificacion" icon="fa fa-check-circle-o" action="update" return="tipoCambio_Certificacion-admin">
			<div class="row">
				<div class="col-md-4">
