...
<tipocambio_certificacion-add>
	<page id="tipocambio_certificacion-add" title="Agregar TipoCambio_Certificacions">
		<formbox title="Datos del TipoCambio_Certificacion" icon="fa fa-check-circle-o" action="create" return="tipoCambio_Certificacion-admin">
			<div class="row">
				<div class="col-md-4">
