...
<tipo_registro_cc_saaim3-edit>
	<page id="tipo_registro_cc_saaim3-edit" title="Editar Tipo_Registro_CC_SAAIM3s">
		<formbox title="Datos del Tipo_Registro_CC_SAAIM3" icon="fa fa-check-circle-o" action="update" return="tipo_Registro_CC_SAAIM3-admin">
			<div class="row">
				<div class="col-md-4">
