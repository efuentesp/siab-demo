...
<entidad_serie-edit>
	<page id="entidad_serie-edit" title="Editar Entidad_Series">
		<formbox title="Datos del Entidad_Serie" icon="fa fa-check-circle-o" action="update" return="entidad_Serie-admin">
			<div class="row">
