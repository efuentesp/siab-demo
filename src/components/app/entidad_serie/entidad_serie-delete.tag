...
<entidad_serie-delete>
	<page id="entidad_serie-delete" title="Eliminar Entidad_Series">
		<formbox title="Datos del Entidad_Serie" icon="fa fa-check-circle-o" action="delete" return="entidad_Serie-admin">
			<div class="row">
			...
			<p hidden>1</p>
				...
				<inputbox id="Serie" type="text" label="Serie" value="" placeholder="Serie de ..." required=true disabled=true />
				</div>
