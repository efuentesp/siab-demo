...
<tipo_registro_saaim3-add>
	<page id="tipo_registro_saaim3-add" title="Agregar Tipo_Registro_SAAIM3s">
		<formbox title="Datos del Tipo_Registro_SAAIM3" icon="fa fa-check-circle-o" action="create" return="tipo_Registro_SAAIM3-admin">
			<div class="row">
				<div class="col-md-4">
