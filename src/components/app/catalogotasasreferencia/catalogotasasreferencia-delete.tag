...
<catalogotasasreferencia-delete>
	<page id="catalogotasasreferencia-delete" title="Eliminar CatalogoTasasReferencias">
		<formbox title="Datos del CatalogoTasasReferencia" icon="fa fa-check-circle-o" action="delete" return="catalogoTasasReferencia-admin">
			<div class="row">
