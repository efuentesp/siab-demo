...
<catalogotasasreferencia-add>
	<page id="catalogotasasreferencia-add" title="Agregar CatalogoTasasReferencias">
		<formbox title="Datos del CatalogoTasasReferencia" icon="fa fa-check-circle-o" action="create" return="catalogoTasasReferencia-admin">
			<div class="row">
