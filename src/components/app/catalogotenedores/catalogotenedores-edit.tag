...
<catalogotenedores-edit>
	<page id="catalogotenedores-edit" title="Editar CatalogoTenedoress">
		<formbox title="Datos del CatalogoTenedores" icon="fa fa-check-circle-o" action="update" return="catalogoTenedores-admin">
			<div class="row">
				<div class="col-md-4">
