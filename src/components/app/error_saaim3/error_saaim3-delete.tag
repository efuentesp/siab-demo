...
<error_saaim3-delete>
	<page id="error_saaim3-delete" title="Eliminar Error_SAAIM3s">
		<formbox title="Datos del Error_SAAIM3" icon="fa fa-check-circle-o" action="delete" return="error_SAAIM3-admin">
			<div class="row">
			...
			<p hidden>2</p>
				<div class="col-md-4">
				<inputbox id="ErrorM3NumCampo" type="number" pattern="[0-9]" onkeypress="return event.charCode >= 48 && event.charCode <= 57" label="Número Campo Error" value="" placeholder="Campo" required=true disabled=true minsize=3 maxsize=100 />
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-4">
				<inputbox id="ErrorM3Consecutivo" type="number" pattern="[0-9]" onkeypress="return event.charCode >= 48 && event.charCode <= 57" label="Consecutivo Error" value="" placeholder="Consecutivo" required=true disabled=true minsize=3 maxsize=100 />
				</div>
			
			<p hidden>4</p>
				<div class="col-md-4">
				
				<inputbox id="ErrorSaaiM3Des" type="textarea" label="Descripción Error" value="" placeholder="Descripción" required=true disabled=true />
				</div>
