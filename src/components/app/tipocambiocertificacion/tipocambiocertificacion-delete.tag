...
<tipocambiocertificacion-delete>
	<page id="tipocambiocertificacion-delete" title="Eliminar TipoCambioCertificacions">
		<formbox title="Datos del TipoCambioCertificacion" icon="fa fa-check-circle-o" action="delete" return="tipoCambioCertificacion-admin">
			<div class="row">
				<div class="col-md-4">
				<date-picker id="Fecha" type= "date" label="Fecha" placeholder="Fecha del Tipo de Cambio" required=true disabled=true />
				</div>
