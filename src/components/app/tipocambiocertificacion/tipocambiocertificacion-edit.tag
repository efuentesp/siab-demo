...
<tipocambiocertificacion-edit>
	<page id="tipocambiocertificacion-edit" title="Editar TipoCambioCertificacions">
		<formbox title="Datos del TipoCambioCertificacion" icon="fa fa-check-circle-o" action="update" return="tipoCambioCertificacion-admin">
			<div class="row">
				<div class="col-md-4">
