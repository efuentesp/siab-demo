...
<tipoerror_saaim3-edit>
	<page id="tipoerror_saaim3-edit" title="Editar TipoError_SAAIM3s">
		<formbox title="Datos del TipoError_SAAIM3" icon="fa fa-check-circle-o" action="update" return="tipoError_SAAIM3-admin">
			<div class="row">
				<div class="col-md-4">
